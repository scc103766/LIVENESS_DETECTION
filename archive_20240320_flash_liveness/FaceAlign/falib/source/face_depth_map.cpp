...
FaceDepthMap::FaceDepthMap(int height, int width): height(height), width(width){
...
void FaceDepthMap::pixelInterpolation(float* vertices, int verticesNum, unsigned char* img){
    float minDepth = 1e32;
    float maxDepth = 0;
