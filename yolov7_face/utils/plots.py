...
from yolov7_face.utils.general import xywh2xyxy, xyxy2xywh
from yolov7_face.utils.metrics import fitness
...
def plot_one_box(x, im, color=None, label=None, line_thickness=3, kpt_label=False, kpts=None, steps=2, orig_shape=None):
    ...
    cv2.rectangle(im, c1, c2, (0,0,255), thickness=tl*1//3, lineType=cv2.LINE_AA)
    if label:
